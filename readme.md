...
### Executing
install required libraries dplyr, reshape2.<br />
creates project folders and sets working directories.<br />
unzips data and run r scrips to result in two tidy datasets according to project requirements.<br />
